            ...
            <Grid container spacing={gridSpacing}>
                                ...
                                enableReinitialize
                                    ...
                                    try {
                                        const response = await axios.post(`${config.backendUrl}/reserpassword`, {
                                            email: userData?.data?.email,password: values.password
                                        });
                                ...
                                >
                                    {({ errors, handleBlur, handleChange, handleSubmit, isSubmitting, touched, values }) => (
                                        <form noValidate autoComplete='off' onSubmit={handleSubmit}>
                                            ...
                                            <Grid item xs={12}>
                                                <Grid container spacing={gridSpacing}>
                                                    <Grid item xs={12} md={6}><FormControl fullWidth error={Boolean(touched.newpassword && errors.newpassword)}>
                                                         <TextField
                                                            id="outlined-adornment-email-login"
                                                            type="password"
                ...
                <Grid item xs={12} md={4}>
                    <Card sx={{
                            ...
                            <Divider />
                            <CardContent>
                                <Typography>To deactivate your account, first delete its resources. If you are the only owner of any teams, either assign another owner or deactivate the team.</Typography>
                                <Box sx={{ mt: 2 }}>
                                    <AnimateButton>
